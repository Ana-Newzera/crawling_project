...
from .comparer_category import ComparerCategory
...
class Comparer:
    ...
    def __init__(self):
        ...
        self.comparer_category = ComparerCategory()
    ...
    def compare(self, item, article_candidates):
        ...
        result.category = self.comparer_category.extract(item, article_candidates)
        return result
